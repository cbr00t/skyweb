		...
		async stokEkBilgileriBelirle(e) {
			...
			let stm = new MQStm({
				sent: new MQSent({
					...
					where: [
						new MQOrClause([
							{ degerAta: stokKod, saha: `stk.ilkTartiKod` },
							{ degerAta: stokKod, saha: `stk.kod` },
							{ degerAta: '0'    + stokKod, saha: `stk.kod` },
							{ degerAta: '00'   + stokKod, saha: `stk.kod` },
							{ degerAta: '000'  + stokKod, saha: `stk.kod` },
							{ degerAta: '0000' + stokKod, saha: `stk.kod` }
						])
					],
					sahalar: [
