(function() {
	window.SkyCafeTextInputPart = class extends window.SkyCafeWindowPart {
		constructor(e) {
			e = e || {};
			super(e);
		...
		async tazeleDevam(e) {
			...
			const textInput = this.textInput = this.initTextInput({
				htmlSelector: `#textInput`, instSelector: 'value', placeHolder: e.placeHolder,
				value: this.value,
