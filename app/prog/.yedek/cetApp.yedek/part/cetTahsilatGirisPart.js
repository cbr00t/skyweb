	...
	window.CETTahsilatGirisPart = class extends window.CETListeOrtakPart {
		...
		async initMustBilgi(e) {
			...
			if (mustKod) {
				...
				if (this.app.musteriRotaZorunlumu)
		...
		async listeArgsDuzenle(e) {
			...
			$.extend(e.listeArgs, {
				editable: true, serverProcessing: false, pageable: true, filterable: true, showToolbar: false,
				toolbarHeight: 42, filterHeight: 28, filterMode: 'default',
