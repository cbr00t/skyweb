	...
	window.CETTahsilatFis = class extends window.CETFis {
		...
		async getMatbuuForm(e) {
			...
			matbuuForm = new CETMatbuuForm({
				...
				digerSahalar: {
					Dip: { pos: { x: 1 } },
					YalnizYazisi: { pos: { x: 1 }, genislik: 40 }
					/*Bakiye: { pos: { x: 8 } , genislik: 40 }*/
				},
				normalSahalar: {
					Aciklama: [
						{ attr: 'Tarih:', pos: { x: 22, y: 4 }, genislik: 6 },
						{ attr: 'Saat :', pos: { x: 22, y: 5 }, genislik: 6 },
					...
					Tekil: [
						...
						{ attr: 'tarih', pos: { x: 30, y: 4 }, genislik: 10 },
						{ attr: 'saat', pos: { x: 30, y: 5 }, genislik: 5 },
