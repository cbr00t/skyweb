	...
	window.CETParam = class extends window.MQTekil {
		constructor(e) {
			...
			$.extend(this, {
				...
				barkodDeviceTip: (this.barkodDeviceTip == null ? 'camera_qrCode' : this.barkodDeviceTip),
		...
		static get sabitAttrListe() {
			return [
				'version', 'wsHostName', 'wsHostName2', 'varsayilanWSHostName', 'wsPort', 'fiyatFra', 'uygunAyrimTipleri', 'subeKod', 'yerKod', 'ilkKM', 'sonKM', 'fisTip2SonSeri',
				...
				'listeKodDogrudanAramaYapilirmi', 'fisOzetBilgiGosterilirmi', 'stokPaketKodlari', 'sonStokKontrolEdilirmi', 'sonStokKontrolEdilirmi_siparis', 'alimNetFiyatGosterilirmi', 'iskSayi', 'satirIskOranSinir', 'musteriRotaZorunlumu', 'rotaDevreDisiGosterilirmi',
				'riskKontrolDurum', 'eIslemKullanilirmi', 'eBelgeAltSinir', 'sicakTeslimFisimi',
				...
				'alimFiyatGorurmu', 'satisFiyatGorurmu', 'konumTakibiYapilirmi', 'konumsuzIslemYapilirmi', 'konumToleransMetre', 'dokumRuloDuzmu',
				'ozelKampanyaKullanilirmi', 'ozelKampanyaOranSayisi', 'otoSonStokGuncellenirmi',
		...
		setValues(e) {
			...
			[	'version', 'dokumDeviceSP_baudRate', 'iskSayi', 'fiyatFra', 'ozelKampanyaOranSayisi' ].forEach(key => {
				let value = this[key];
			...
			[	'serbestModmu', 'gridAltMultiSelectFlag', 'dokumEkranami', 'stokFiyatKdvlimi', 'yildizKullanilirmi', 'darDokummu', 'dokumNettenmi', 'sonStokKontrolEdilirmi', 'sonStokKontrolEdilirmi_siparis',
				'dogrudanFisListeyeGirilirmi', 'barkodluFisGirisYapilirmi', 'fisGirisSadeceBarkodZorunlumu', 'geciciFisKullanilmazmi', 'listeKodDogrudanAramaYapilirmi', 'fisOzetBilgiGosterilirmi' ,'silerekBilgiAlYapilirmi',
				 'alimNetFiyatGosterilirmi', 'bakiyeRiskGosterilmezmi', 'musteriRotaZorunlumu', 'ilkIrsaliyeDokumuZorunlumu', 'kmTakibiYapilirmi', 'faturadaTahsilatYapilirmi', 'yazdirilanTahsilatDegistirilmezmi', 'tahsilatIptalEdilemezmi',
				...
				'alimFiyatGorurmu', 'satisFiyatGorurmu', 'ozelKampanyaKullanilirmi', 'konumTakibiYapilirmi', 'konumsuzIslemYapilirmi', 'otoSonStokGuncellenirmi', 'dokumRuloDuzmu', 'kapandimi'
			].forEach(key => {
				let value = this[key];
				// if (value != null)
