...
(function() {
	window.CBasiSonu = class extends window.CObject {
		constructor(e) {
			...
			$.extend(this, {
				basi: e.basi == null ? e.Basi : e.basi,
				sonu: e.sonu == null ? e.Sonu : e.sonu
			});
		}

		static get empty() {
			return new this({ basi: '', sonu: '' })
		}

		static get zero() {
			return new this({ basi: 0, sonu: 0 })
		}

		static fromText(e) {
			e = e || {};
			if (typeof e == 'object' && !$.isPlainObject(e))		// CBasiSonu gelmistir
				return e;
			...
			if (typeof value == 'object') {
				...
				const converter = e.converter;
				if (converter) {
					['basi', 'sonu'].forEach(key => {
						let value = inst[key];
						inst[key] = value = converter.call(inst, { value: value });
					})
				}
				return inst;
			}
			...
			const converter = e.converter || (value => value);
			return new this({
